...
```
`aws ec2 describe-tags --filters "Name=resource-id,Values=<YourInstanceID>"` command to check tags associated with ur particular EC2 instance, instance id needed.
